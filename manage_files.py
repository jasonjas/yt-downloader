...
class DefaultLocations:
    def __init__(self):
        ...
        self.outputdir_initial = "E:\\zztransfer\\"
        self.itunesdir = "E:\\Music\\iTunes\\iTunes Media\\Automatically Add to iTunes\\"
        self.historyfile = "history.txt"
        self.genres_file = "genres.txt"

    def read_file(self):
        with open(self.file, 'r') as rf:
            df_contents = rf.read(json.loads(rf.readlines()))
        return df_contents
